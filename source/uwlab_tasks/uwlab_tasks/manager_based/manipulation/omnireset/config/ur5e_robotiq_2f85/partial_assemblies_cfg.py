...
variants = {
    "scene.insertive_object": {
        ...
        # Real thin PCB (140x100x3 mm). Grasp/reach/resting object only -- it does NOT fit the
        # openbox, so partial-assembly (C4 / insertion) is N/A; see REALPCB_THIN_DEVIATION_LEDGER.md.
