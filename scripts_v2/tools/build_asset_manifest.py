...
CLASS1: list[Asset] = [
    ...
    Asset(
        ...
        "every certification launcher for dexlift certs (cert_ft.sh:35, cert30.sh:7, cert_both.sh:7) "
    ...
    Asset(
        ...
        "recorded in every cert JSON, but read by nothing. Only run_certify.sh's own post-hoc "
