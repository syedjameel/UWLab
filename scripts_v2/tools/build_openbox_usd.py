...
def main() -> None:
    ...
    parser.add_argument("--pcb-length", type=float, default=0.040, help="Mating PCB length along X (m).")
    ...
    metadata = {
        ...
        # Forgiving place-in-tray thresholds for a learnable demo (loosen orientation).
